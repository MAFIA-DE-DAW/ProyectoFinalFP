...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2026 a las 21:43:18
...
(16, 5, 'Luisito', 'planta', 'verde', 0, 0, 0, 0, 100, '2026-05-07 20:22:56', 0),
(30, 8, 'prueba2', 'planta', 'verde', 0, 14, 0, 14, 100, '2026-05-07 21:13:50', 0),
(31, 2, 'Paco', 'animal', 'azul', 90, 85, 85, 70, 100, '2026-05-07 21:41:50', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `mascotas_historial`
--
...
CREATE TABLE `mascotas_historial` (
  ...
  `sueno` int(11) DEFAULT NULL,
  `diversion` int(11) DEFAULT NULL,
  `higiene` int(11) DEFAULT NULL,
  `salud` int(11) DEFAULT NULL,
  `basura` tinyint(1) DEFAULT 0,
...
--
-- Volcado de datos para la tabla `mascotas_historial`
--

INSERT INTO `mascotas_historial` (`id`, `id_usuario`, `nombre`, `tipo`, `color`, `hambre`, `sueno`, `diversion`, `higiene`, `salud`, `basura`, `fecha_ultima_actualizacion`, `fecha_fin`, `motivo_fin`) VALUES
(12, 8, 'pruebahistorial', 'planta', 'verde', 0, 0, 0, 0, 100, 0, '2026-05-07 20:37:48', '2026-05-07 20:42:56', 'muerte');
...
(56, 8, 8, '2026-05-07 20:40:46'),
(57, 2, 12, '2026-05-07 21:41:11'),
(58, 2, 18, '2026-05-07 21:41:26');
...
(8, 'Limpieza de Playas', 'Contribuyes a la recogida manual de plásticos y residuos en nuestras costas.', '🌊', 45, 'Retira 15kg de plásticos del mar.'),
(9, 'Energía Solar Escolar', 'Instalación de paneles fotovoltaicos en colegios públicos para reducir emisiones.', '☀️', 80, 'Ahorra 1MWh de energía contaminante.'),
(10, 'Santuario de Abejas', 'Creación de colmenas urbanas y siembra de flores silvestres para polinizadores.', '🐝', 35, 'Ayuda a polinizar 5.000 flores nuevas.'),
(11, 'Reforestar el Amazonas', 'Siembra de árboles autóctonos en zonas protegidas de la selva amazónica.', '🌴', 100, 'Captura 1 tonelada de CO2 en 10 años.'),
(12, 'Pozos de Agua Solar', 'Construcción de pozos con bombeo solar en zonas con escasez de agua.', '💧', 65, 'Suministra agua potable a 5 familias.'),
(13, 'Huerto Comunitario', 'Creación de espacios de cultivo urbano sostenible para vecinos del barrio.', '🍅', 40, 'Produce 30kg de vegetales frescos locales.');
...
(8, 'pruebahistorial', 'pruebahistorial@historial', '$2y$10$bExr7ptLpTgO9jFBAW3gP.IObCh3bOOTCsjJ5CXuHEtGIROgs/KDq', '2026-05-07 20:39:59', 20);
...
--
-- Indices de la tabla `mascotas_historial`
--
...
--
-- AUTO_INCREMENT de la tabla `mascotas_historial`
--
ALTER TABLE `mascotas_historial`
...
--
-- Filtros para la tabla `mascotas_historial`
--
ALTER TABLE `mascotas_historial`
  ADD CONSTRAINT `mascotas_historial_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);
