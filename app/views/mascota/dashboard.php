...
$misiones = $misiones ?? [];
$nivel_eco = $nivel_eco ?? 50;
$color_barra = $color_barra ?? "#22c55e";
$monedas_verdes = $monedas_verdes ?? 0;
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="dashboard-body">
    <div class="dashboard">
        ...
        <header>
            ...
            <div class="usuario">
                <div class="monedas-verdes">
                    <span class="emoji">💚</span>
                    <span class="cantidad"><?php echo number_format($monedas_verdes ?? 0); ?></span>
                    <span class="texto">Monedas Verdes</span>
                </div>
                <span>Jugador: <strong><?php echo $_SESSION["usuario_nombre"] ?? "Usuario"; ?></strong></span>
                <a href="tienda.php" class="btn-tienda">Tienda Verde</a>
                <a href="mi_cuenta.php" class="btn-cuenta">
                    👤 Mi cuenta
                </a>
                ...
                <div class="layout-principal">
                    <div class="columna-juego">
                        ...
                        <div class="acciones">
                            ...
                            <form action="accion_mascota.php" method="POST"><input type="hidden" name="accion" value="dormir"><button type="submit" class="accion-btn" id="btn-dormir">😴 DORMIR</button></form>
                            <form action="accion_mascota.php" method="POST"><input type="hidden" name="accion" value="jugar"><button type="submit" class="accion-btn" id="btn-jugar">🎾 JUGAR</button></form>
                            <form action="accion_mascota.php" method="POST"><input type="hidden" name="accion" value="duchar"><button type="submit" class="accion-btn" id="btn-duchar">🛁 DUCHAR</button></form>
                        </div>
                            ...
                            <?php foreach ($misiones as $mision): ?>
                                <form action="completar_mision.php" method="POST">
                                    ...
                                    <div class="mision">
                                        ...
                                        <p class="recompensa-monedas">+<?php echo $mision["puntos_monedas"] ?? 5; ?> 💚 Monedas Verdes</p>
